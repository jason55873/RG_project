...
class Department(models.Model):
    dept_no = models.CharField(max_length=20, unique=True, verbose_name=_("部門編號"))
    dept_name = models.CharField(max_length=100, verbose_name=_("部門名稱"))
    parent_dept = models.ForeignKey('self', null=True, blank=True, on_delete=models.SET_NULL, related_name='sub_departments', verbose_name=_("上層部門"))
...
class Employee(models.Model):
    ...
    mobile = models.CharField(max_length=20, verbose_name=_("行動電話"))
    birth = models.DateField(verbose_name=_("出生日期"))
    ...
    title = models.CharField(max_length=50, verbose_name=_("職稱"), blank=True, null=True)
